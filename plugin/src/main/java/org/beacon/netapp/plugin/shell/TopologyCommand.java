package org.beacon.netapp.plugin.shell;
...
import org.beacon.netapp.plugin.TopologyForwarder;
import org.beacon.netapp.plugin.model.Topology;

@Command(scope = "opennms-netapp-plugin", name = "push-topology", description = "Push the topology")
@Service
